...
class PageController extends Controller
{
    public function home()
    {
        ...
        $shopProducts = \App\Models\ShopProduct::active()->featured()->orderBy('sort_order')->take(4)->get();
        return view('pages.home', compact('content', 'featuredCourses', 'shopProducts'));
    }
    ...
    public function instructors()
    {
        ...
        return view('pages.instructors', compact('tutors'));
    }
    ...
    public function meetAuntieKash() { return view('pages.meet-auntie-kash'); }
    public function terms()        { return view('pages.terms'); }
    public function anthem()       { return view('pages.anthem'); }
}
