...
class DiscoveryController extends Controller
{
    ...
    /** CEO assigns a staff member (Admin/CEO/Tutor) to handle this call. */
    public function assignStaff(Request $request, int $id)
    {
        if (! \Illuminate\Support\Facades\Auth::user()->isCEO()) abort(403);
        ...
        $form->update([
            ...
            'assigned_at' => $data['assigned_staff_id'] ? now() : null,
        ]);
        return back()->with('success', 'Discovery call assignment updated.');
    }
}
