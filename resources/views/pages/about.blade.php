    ...
    <div class="container">
        <div class="grid lg:grid-2 items-center gap-6">
            <div style="max-width:360px;margin:0 auto;position:relative;">
                <div style="aspect-ratio:1;border-radius:50%;overflow:hidden;border:4px solid rgba(255,62,158,0.5);max-width:320px;margin:0 auto;">@php $founderPhoto = \App\Models\SiteSetting::get('founder_photo'); @endphp @if($founderPhoto)<img src="{{ $founderPhoto }}" alt="{{ $about['founderName'] }}" style="width:100%;height:100%;object-fit:cover;">@else<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#7B2FF7,#FF3E9E);color:#fff;font-size:64px;">👩🏾</div>@endif</div>
            </div>
            <div data-reveal>
